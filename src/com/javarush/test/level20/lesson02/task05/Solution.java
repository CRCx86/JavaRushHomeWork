...
public class Solution {
    public static void main(java.lang.String[] args) {
        ...
        try {
            ...
            System.out.print    (object.equals(loadedObject));
    ...
    public static class Object {
        ...
        public synchronized void save(OutputStream outputStream) throws Exception {
            //implement this method - реализуйте этот метод
            PrintStream printStream = new PrintStream(outputStream);
            try { printStream.println(string1.number); } catch (Exception ignore) {printStream.println("no");}
            try { printStream.println(string2.number); } catch (Exception ignore) {printStream.println("no");}
            printStream.flush();
        }
