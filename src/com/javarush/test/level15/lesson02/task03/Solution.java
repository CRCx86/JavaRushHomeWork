...
public class Solution {
    ...
    public static class Ferrari extends LuxuriousCar{
        public void printlnDesire() {
            //add your code here
            System.out.print(Constants.WANT_STRING + Constants.FERRARY_NAME);
        }
    }
    ...
    public static class Lanos extends CheapCar {
        public void printlnDesire() {
            //add your code here
            System.out.print(Constants.WANT_STRING + Constants.LANOS_NAME);
        }
    }
    ...
    public static class LuxuriousCar {
        protected void printlnDesire() {
            //add your code here
            System.out.print(Constants.WANT_STRING + Constants.LUXURIOUS_CAR);
        }
    }
    ...
    public static class CheapCar {
        protected void printlnDesire() {
            //add your code here
            System.out.print(Constants.WANT_STRING + Constants.CHEAP_CAR);
        }
    }
