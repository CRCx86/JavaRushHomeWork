...
public class Solution {
    ...
    public static class Gamer extends Thread {
        private int rating;
        private int count = 0;
        private int countSteps = OnlineGame.steps.size();
...
//            try {
//                while (count < rating) {
//                    System.out.println(getName() + ":" + OnlineGame.steps.get(count));
//                    Thread.sleep(1000 / rating);
//                    count++;
//                    if (count == countSteps - 1) {
...
//
//            }
//            if (count < countSteps) System.out.println(getName() + ":проиграл");
